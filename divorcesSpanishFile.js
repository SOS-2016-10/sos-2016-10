...
module.exports.getDivorces = (req,res)=>{
  //req.params.autonomous_community
  var com = req.query.community;
  console.log(com);
  var yea = req.query.year;
  if(com != null){

    res.send(divorces[0]);
  }
  //limit & offset
  /*var count = req.query.limit || 3; //Leo de URL, o por defecto es 3
	var page = req.query.offset || 1; //Leo de URL, o por defecto es 1
  ...
  app.use(paginate.middleware(1, 1));
  //res.send(divorces.paginate({},{page: req.query.page, limit: req.query.limit} ));
  //res.send(divorces);
